...
const Hero = () => {
  return (
    <div className="kabert__hero bg-stone-100 text-gray-700 pt-20" id="home">
      <div className="h-96 bg-fixed bg-left bg-gradient-to-b from-black to-gray-400 relative">
        <img
          src={kabert2}
          alt="nothing here"
        ...
        />
        <div>
          <h1 className="text-7xl font-bold py-2 m-5 mt-16 bg-gradient-to-r from-emerald-500 to-slate-300 text-transparent bg-clip-text inline-block">
            Serving aluminum makers since 1960.
          </h1>
          <p className="text-right text-5xl m-5 pb-2 font-bold bg-gradient-to-r from-slate-300 to-emerald-500 text-transparent bg-clip-text">
